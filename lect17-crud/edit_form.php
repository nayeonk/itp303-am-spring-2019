...
if ( !isset($_GET['track_id']) || empty($_GET['track_id']) ) {
	...
	// Get the details of this track based on the track_id that was given to us.
...
<body>
	...
	<div class="container">
		...
		<form action="edit_confirmation.php" method="POST">
			...
			<!-- Pass the track_id variable to edit_confirmation.php using a hidden input field -->
				...
				<div class="col-sm-9">
					<select name="genre" id="genre-id" class="form-control">
						...
						<?php while( $row = $results_genres->fetch_assoc() ): ?>
							...
							<!-- If genre is this track's genre, add a 'selected' attribute to it -->
